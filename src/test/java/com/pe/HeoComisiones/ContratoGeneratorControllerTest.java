...
public class ContratoGeneratorControllerTest {
    ...
    void whenGenerateContratoWithValidData_thenReturnsOk() throws Exception {
        ContratoValuesRequest contratoValuesRequest = ContratoValuesRequest.builder()
                ...
                .generardocumento("CONLOGO")
                .nombrecompleto("Giuseppe Barrera")
                .capital("10000")
                .vigencia_numero_letras("50")
                .genero("MASCULINO") // Asegúrate de que la entidad acepte el valor completo "MASCULINO"
                .porcentaje("12")
                .vigencia_texto_letras("cincuenta")
                .tipodocumento("DNI")
                .rentasletras("doce por ciento")
                .dia_inicio("02/01/2024") // Asumiendo que hay campos correspondientes en la clase DTO
                .numero_documento("71458660")
                .rentomonto("1200")
                .dia_fin("10/01/2024") // Asumiendo que hay campos correspondientes en la clase DTO
                .direccion("jr jose pardo")
                .totalmonto("11200")
                .correo("barrer_romero@hotmial.com")
                .departamento("San Martín")
                .tipocuentacliente("ahorro")
                .celular("933632298")
                .provincia("Picota")
                .cuentacliente("12212")
                .fecha_inicio_letras("02 de Enero del 2024")
                .distrito("Picota")
                .banco_cliente("Banco de la Nacion")
                .documento_de("ERICK PAREDES PAREDES")
                .ocupacion("lapiicto")
                .bancoheo("BANBIF")
                .cuentaheo("03868010700075171155")
